...
<?php else: ?>
    <div class="col-md-12 text-center mt-5">
        <a href="<?php echo e(route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])); ?>" class="btn btn-primary">View Products</a>
    </div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\adanSolutionAdmin-master\resources\views/web-views/partials/_category-list-ajax.blade.php ENDPATH**/ ?>