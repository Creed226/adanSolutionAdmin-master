<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('seller.orders.list',['pending'])); ?>" style="background: #3E215D">
        <div class="card-body">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('seller.orders.list',['confirmed'])); ?>" style="background: #001E6C">
        <div class="card-body">
            <h6 class="card-subtitle"
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('seller.orders.list',['processing'])); ?>" style="background: #053742">
        <div class="card-body">
            <h6 class="card-subtitle"
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('seller.orders.list',['out_for_delivery'])); ?>" style="background: #343A40">
        <div class="card-body">
            <h6 class="card-subtitle"
        ...
        <div class="row gx-lg-4">
            <div class="col-sm-6 col-lg-3">
                <div class="media" style="cursor: pointer"
                     onclick="location.href='<?php echo e(route('seller.orders.list',['delivered'])); ?>'">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media" style="cursor: pointer"
                     onclick="location.href='<?php echo e(route('seller.orders.list',['canceled'])); ?>'">
                    <div class="media-body">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-lg">
                <div class="media" style="cursor: pointer"
                     onclick="location.href='<?php echo e(route('seller.orders.list',['returned'])); ?>'">
                    <div class="media-body">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media" style="cursor: pointer"
                     onclick="location.href='<?php echo e(route('seller.orders.list',['failed'])); ?>'">
                    <div class="media-body">
...
<?php /**PATH C:\xampp\htdocs\adanSolutionAdmin-master\resources\views/seller-views/partials/_dashboard-order-stats.blade.php ENDPATH**/ ?>