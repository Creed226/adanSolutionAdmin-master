        ...
        <div class="rating-show">
            <span class="d-inline-block font-size-sm text-body">
                <?php for($inc=0;$inc<5;$inc++): ?>
                    ...
                    <?php endif; ?>
                <?php endfor; ?>
                <label class="badge-style">( <?php echo e($product->reviews()->count()); ?> )</label>
            </span>
        </div>
...
<?php /**PATH C:\xampp\htdocs\adanSolutionAdmin-master\resources\views/web-views/partials/_single-product.blade.php ENDPATH**/ ?>