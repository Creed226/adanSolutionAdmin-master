                    ...
                    <div class="card-body">
                        ...
                        <form class="js-validate" action="<?php echo e(route('seller.auth.login')); ?>" method="post">
                            ...
                            <a class="d-flex justify-content-center mb-5" href="javascript:">
                                    <img class="z-index-2" width="120px" src="<?php echo e(asset("company/".$e_commerce_logo)); ?>" alt="Logo"
...
<?php /**PATH C:\xampp\htdocs\adanSolutionAdmin-master\resources\views/seller-views/auth/login.blade.php ENDPATH**/ ?>