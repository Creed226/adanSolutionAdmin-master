...
<?php $__env->startSection('content'); ?>
    ...
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo e(route('seller.dashboard.index')); ?>">Dashboard</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('seller.product.list')); ?>">Product</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="<?php echo e(route('seller.product.update',$product->id)); ?>" method="post"
                            ...
                            <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="<?php echo e($lang != 'en'? 'd-none':''); ?> lang_form" id="<?php echo e($lang); ?>-form">
                                    ...
                                    <div class="form-group pt-4">
                                        <label class="input-label"><?php echo e(trans('messages.description')); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-2 mb-2">
                                        <div class="customer_choice_options" id="customer_choice_options">
                                            <?php echo $__env->make('seller-views.product.partials._choices',['choice_no'=>json_decode($product['attributes']),'choice_options'=>json_decode($product['choice_options'],true)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" min="0" step="0.01"
                                               ...
                                               value=<?php echo e(\App\CPU\BackEndHelper::usd_to_currency($product->unit_price)); ?> required>
                                    </div>
                                    <div class="col-md-6">
                                        <label
                                        ...
                                        <input type="number" min="0" step="0.01"
                                               ...
                                               value=<?php echo e(\App\CPU\BackEndHelper::usd_to_currency($product->purchase_price)); ?> required>
                                    </div>
                                </div>
                                <div class="row pt-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" min="0"
                                               value=<?php echo e($product->discount_type=='flat'?\App\CPU\BackEndHelper::usd_to_currency($product->discount): $product->discount); ?> step="0.01"
                                ...
                                <div class="sku_combination pt-4" id="sku_combination">
                                    <?php echo $__env->make('seller-views.product.partials._edit_sku_combinations',['combinations'=>json_decode($product['variation'],true)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img style="width: 100%" height="auto"
                                                             ...
                                                             src="<?php echo e(asset("product/meta")); ?>/<?php echo e($product['meta_image']); ?>"
                                                             alt="Meta image">
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <input type="text" value="<?php echo e($product['video_url']); ?>" name="video_link" placeholder="EX : https://www.youtube.com/embed/5R06LRdUCSE" class="form-control" required>
                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <img style="width: 100%" height="auto"
                                                                 ...
                                                                 alt="Product image">
                                                            <a href="<?php echo e(route('seller.product.remove-image',['id'=>$product['id'],'name'=>$photo])); ?>"
...
<?php $__env->startPush('script'); ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            getRequest('<?php echo e(url('/')); ?>/seller/product/get-categories?parent_id=' + category + '&sub_category=' + sub_category, 'sub-category-select', 'select');
            getRequest('<?php echo e(url('/')); ?>/seller/product/get-categories?parent_id=' + sub_category + '&sub_category=' + sub_sub_category, 'sub-sub-category-select', 'select');
    ...
    <script>
        function check(){
            ...
            $.post({
                url: '<?php echo e(route('seller.product.update',$product->id)); ?>',
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
...
<?php echo $__env->make('layouts.back-end.app-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\adanSolutionAdmin-master\resources\views/seller-views/product/edit.blade.php ENDPATH**/ ?>