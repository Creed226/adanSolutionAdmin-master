...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
          href="<?php echo e(asset('company')); ?>/<?php echo e($web_config['fav_icon']->value); ?>">
...
<script>
    ...
    function currency_change(currency_code) {
        ...
        $.ajax({
            ...
            success: function (data) {
                toastr.success('Monnaie changée avec succès' + data.name);
                location.reload();
            }
        });
    }
...
<?php /**PATH /home/jj/Desktop/MrZ/WebVision/AdamG/Admin/resources/views/layouts/front-end/app.blade.php ENDPATH**/ ?>