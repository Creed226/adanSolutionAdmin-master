                                ...
                                <div class="navbar-tool-icon-box bg-secondary">
                                    <div class="navbar-tool-icon-box bg-secondary">
                                        <img style="width: 40px;height: 40px"
                                             src="{{asset('profile/'.auth('customer')->user()->image)}}"
                                             onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                             class="img-profile rounded-circle">
                                    </div>
                                </div>
                                <div class="navbar-tool-text">
                                    <small> {{ trans('messages.Hello')}} {{auth('customer')->user()->f_name}}</small>
                                    Dashboard
                                </div>
                            </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if($seller_registration)
                            <li class="nav-item">
                                <div class="dropdown">
                                    <a class="btn "  href="{{route('seller.auth.login')}}" style="color: white;margin-top: 5px;">
                                        <b> {{ trans('messages.seller_prest')}}  </b>
                                    </a>
